...
import 'package:trees_demo/checkable_todo_item.dart';

// import 'package:trees_demo/todo_item.dart';
          ...
          child: Column(
            children: [
              ...
              for (final todo in _orderedTodos)
                CheckableTodoItem(
                  // key: ObjectKey(todo),
                  // Pitää olla uniikka arvo, ei voi olla samaa tekstiä eri ToDo objekteilla
                  // Objektissa voisi olla uniikki ID property
